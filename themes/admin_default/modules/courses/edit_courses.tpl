	...
	<table class="tab1">
		<tbody>
			<tr>
				...
				<td>
				<input type="text" name="makh" value="{DATA.id_courses}"  />
				</td>
			</tr>
		</tbody>
		...
		<tbody>
			<tr>
				...
				<td>
				<input id="idtitle" type="text" name="tenkh" value="{DATA.name_courses}"  />
				</td>
			</tr>
		</tbody>
		...
		<tbody>
			<tr>
				...
				<td>
				<input type="text" name="lichkh" value="{DATA.schedule}"  />
				</td>
			</tr>
		</tbody>
		...
		<tbody>
			<tr>
				...
				<td>
				<input type="text" name="thoiluong" value="{DATA.duration}"  />
				</td>
			</tr>
		</tbody>
		...
		<tbody>
			<tr>
				...
				<td>
				<input type="text" id="hocphi" name="hocphi" value="{DATA.fee}"  />
				</td>
			</tr>
		</tbody>
		...
		<tbody>
			<tr>
				...
				<td>
				<input type="text" name="slhv" value="{DATA.total}"  />
				</td>
			</tr>
		</tbody>
		...
		<tbody>
			<tr>
				...
				<td>
				<input id="timestart" name="timestart"  type="text"  value="{DATA.time_start}"  />
				</td>
			</tr>
		</tbody>
		...
		<tbody>
			<tr>
				<td>{LANG.timeend}:</td>
				<td>
				<input id="timeend" type="text" name="timeend" value="{DATA.time_end}"  />
				</td>
			</tr>
		</tbody>
