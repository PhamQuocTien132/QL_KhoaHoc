...
<html xmlns="http://www.w3.org/1999/xhtml" prefix="og: http://ogp.me/ns#">
	<head>
		...
		<script type="text/javascript" src="{NV_BASE_SITEURL}themes/{TEMPLATE}/js/jquery-1.5.2.min.js"></script>
		<script type="text/javascript" src="{NV_BASE_SITEURL}themes/{TEMPLATE}/js/jquery.maskedinput-1.3.min.js"></script>
	</head>